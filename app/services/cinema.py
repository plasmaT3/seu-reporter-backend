...
CINEMA_FEEDS = [
    "https://www.adorocinema.com/rss/filmes.xml",  # AdoroCinema
    "https://www.cinemaemcena.com.br/rss",         # Cinema em Cena
    "https://rss.uol.com.br/feed/entretenimento.xml"  # UOL Entretenimento (tem cinema junto)
]

def fetch_movie_news():
    noticias = []
    for url in CINEMA_FEEDS:
